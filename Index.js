...
client.on('messageCreate', async (msg) => {
    ...
    */
    ...
    const BannedWords = ["fuck", "shit", "ass", "dumbass", "fucktard", "crap", "fucking"]
    if (BannedWords.some(word => msg.toString().toLowerCase().includes(word))) {msg.delete().catch(e => console.error("Couldn't delete message.")); message.reply(`Please do not swear.`)};
	}
});
